    ...
    def assign_orientations(self, keypoints, image):
        ...
        for key_point in keypoints:
            ...
            if hist_smoothed[max_idx] == 0:
                continue # If the peak value in the histogram is 0, it means there is no significant gradient information around the keypoint.
In such cases, the keypoint is skipped.
